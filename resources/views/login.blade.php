<x-layout>
    ...
    <main class="min-h-screen bg-stone-50 px-4 py-4 font-sans text-neutral-950 sm:px-6 sm:py-6 lg:px-8">
        <div class="mx-auto flex min-h-[calc(100vh-2rem)] w-full max-w-6xl items-center sm:min-h-[calc(100vh-3rem)]">
            <div class="grid w-full overflow-hidden rounded-lg border border-neutral-200 bg-white shadow-sm lg:min-h-180 lg:grid-cols-[1fr_0.95fr]">
                <section class="hidden flex-col gap-8 border-b border-neutral-200 bg-stone-100 p-5 sm:p-8 lg:flex lg:border-b-0 lg:border-r lg:p-10">
                    <a href="{{ url('/') }}" class="flex w-fit items-center gap-3 font-semibold tracking-tight text-neutral-950">
                        <img src="{{ asset('scrumlab-icon.svg') }}" alt="" class="size-10 shrink-0">
                        <span>{{ config('app.name') }}</span>
                    </a>

                    <div class="max-w-xl lg:my-auto">
                        <p class="mb-4 text-xs font-semibold uppercase tracking-[0.18em] text-neutral-500">Project workspace</p>
                        <h1 class="text-3xl font-bold leading-tight tracking-normal text-neutral-950 min-[420px]:text-4xl sm:text-5xl">
                        ...
                        <p class="mt-5 max-w-lg text-sm leading-6 text-neutral-600 sm:text-base sm:leading-7">
                            Sign in to manage projects, review sprint boards, update issues, and keep team progress visible.
                        </p>
                    </div>
                    ...
                    <div class="rounded-lg border border-neutral-200 bg-white p-4">
                        <div class="mb-4 flex items-center justify-between gap-3">
                            ...
                            <span class="shrink-0 rounded-md bg-neutral-100 px-2.5 py-1 text-xs font-semibold text-neutral-700">68%</span>
                        </div>
                        ...
                        <div class="grid gap-3 min-[520px]:grid-cols-3 lg:grid-cols-1 xl:grid-cols-3">
                            <div class="rounded-md border border-neutral-200 bg-stone-50 p-3">
                                ...
                                <div class="rounded-md border border-neutral-200 bg-white p-3 text-sm font-medium">Invite team members</div>
                            </div>
                            <div class="rounded-md border border-neutral-200 bg-stone-50 p-3">
                                <p class="mb-3 text-xs font-semibold text-neutral-500">In progress</p>
                                <div class="rounded-md border border-neutral-200 bg-white p-3 text-sm font-medium">Sprint planning panel</div>
                            </div>
                            <div class="rounded-md border border-neutral-200 bg-stone-50 p-3">
                                <p class="mb-3 text-xs font-semibold text-neutral-500">Done</p>
                                <div class="rounded-md border border-neutral-200 bg-white p-3 text-sm font-medium">Issue comments</div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section class="flex items-center justify-center p-5 sm:p-8 lg:p-10">
                    <div class="w-full max-w-md">
                        <div class="mb-8">
                            ...
                            <h2 class="mt-2 text-2xl font-bold tracking-normal text-neutral-950 sm:text-3xl">Log in to ScrumLab</h2>
                            <p class="mt-3 text-sm leading-6 text-neutral-500">Use your workspace credentials to continue.</p>
                        </div>
                        ...
                        <form action="#" method="POST" class="space-y-5">
                            ...
                            <div>
                                ...
                                <div class="relative mt-2">
                                    ...
                                    <button type="button" data-password-toggle="password" aria-label="Show password"
                                        ...
                                        <svg class="size-5" data-eye-icon xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" aria-hidden="true">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12s3.75-6.75 9.75-6.75S21.75 12 21.75 12 18 18.75 12 18.75 2.25 12 2.25 12Z" />
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                                        </svg>
                                        <svg class="hidden size-5" data-eye-off-icon xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" aria-hidden="true">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M3 3l18 18" />
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M10.73 5.08A10.73 10.73 0 0 1 12 5c6 0 9.75 7 9.75 7a17.93 17.93 0 0 1-3.33 4.24" />
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M6.61 6.61C3.8 8.5 2.25 12 2.25 12S6 19 12 19a10.7 10.7 0 0 0 4.08-.8" />
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M9.88 9.88A3 3 0 0 0 14.12 14.12" />
                                        </svg>
                            ...
                            <div class="flex flex-col gap-3 text-sm min-[420px]:flex-row min-[420px]:items-center min-[420px]:justify-between">
                                ...
                                <a href="#" class="font-semibold text-neutral-950 underline decoration-neutral-300 underline-offset-4 transition hover:decoration-neutral-950">Forgot password?</a>
                            </div>
                        ...
                        <p class="mt-8 text-center text-sm text-neutral-500">
                            New to ScrumLab?
                            <a href="{{ route('register') }}" class="font-semibold text-neutral-950 underline decoration-neutral-300 underline-offset-4 transition hover:decoration-neutral-950">Create an account</a>
                        </p>
                    </div>
                </section>
            </div>
    ...
    <script>
        document.querySelectorAll('[data-password-toggle]').forEach((button) => {
            button.addEventListener('click', () => {
                ...
                button.querySelector('.sr-only').textContent = shouldShow ? 'Hide password' : 'Show password';
